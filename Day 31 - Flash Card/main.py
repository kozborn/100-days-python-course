...
canvas = tk.Canvas(window, width=800, height=526, bg=BACKGROUND_COLOR, borderwidth=0, highlightthickness=0)
...
right_button = tk.Button(window, command=accept, image=button_right, borderwidth=0, highlightthickness=0)
right_button.grid(row=1, column=1)

wrong_button = tk.Button(window, command=reject, image=button_wrong, borderwidth=0, highlightthickness=0)
